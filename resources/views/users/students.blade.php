<x-app-layout>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-md md:text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás seguro de que deseas eliminar este alumno?</h3>
    ...
    <div class="flex justify-between">
        <div class="w-full">
            <h1 class="text-center mt-3 text-destacar tit">ALUMNOS</h1>
        </div>
        @auth
