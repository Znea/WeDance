<x-app-layout>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-md md:text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás seguro de que deseas eliminar esta clase?</h3>
    ...
    <div class="flex justify-between">
        <div class="w-full">
            <h1 class="text-center mt-3 text-destacar tit">CLASES</h1>
        </div>
        @auth
    ...
    @foreach ($clases as $c )
        <div class="contenedor" data-aos="zoom-in">
            ...
            <form class="mt-3" action="{{route('clases.show', ['clase' => $c->id])}}">
                <button class="w-full login bg-secondary">SABER MÁS</button>
            </form>
        </div>
    @endforeach
</x-app-layout>
