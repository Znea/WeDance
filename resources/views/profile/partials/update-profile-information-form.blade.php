    ...
    <form id="send-verification" method="post" action="{{ route('profile.update') }}">
        ...
        <div class="mt-9">
            <div class="md:flex items-center justify-between">
                <!-- Name -->
                <div class="relative z-0 w-full mb-5 group md:me-2" x-data="{ focused: false }">
                ...
                <!-- LastName -->
                <div class="relative z-0 w-full mb-5 group md:ms-2" x-data="{ focused: false }">
            ...
            <div class="text-start">
                <input id="image" name="image" type="file" class="mt-1 w-full" :value="old('image', $user->image)" autofocus autocomplete="image" />
